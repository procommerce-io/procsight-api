...
var genesisTXID = '0000040154f262df86de1eb539d4bb05ebd5aa8448bdbff066c614e705b5af26'; //ProCurrency
var CONCURRENCY = 5;
...
var encodedData = require('soop').load('proccore/util/EncodedData', {
  base58: base58
});
var versionedData = require('soop').load('proccore/util/VersionedData', {
  parent: encodedData
});

var Address = require('soop').load('proccore/lib/Address', {
